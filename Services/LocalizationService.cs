...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Cancel"] = "Cancel",
        ["ArtTitle"] = "Picture",
        ["ArtFromDevice"] = "From this device",
        ["ArtFromUrl"] = "From a web address",
        ["ArtSearchGoogle"] = "Search it on Google",
        ["ArtRemove"] = "Remove the custom one",
        ["ArtUrlTitle"] = "Address of the picture",
        ["ArtUrlMessage"] = "Paste the address of the image (right click on it, «Copy image address»).",
        ["ArtSaved"] = "Picture saved.",
        ["ArtFailed"] = "The picture could not be used",
        ["Close"] = "Close",
        ["Create"] = "Create",
        ["Delete"] = "Delete",
        ["Understood"] = "Got it",
        ...
        ["TabArtists"] = "Artists",
        ["AutoShuffleOn"] = "Shuffle: on",
        ["AutoShuffleOff"] = "Shuffle: off",
        ["AutoRepeatOff"] = "Repeat: off",
        ["AutoRepeatAll"] = "Repeat: all",
        ["AutoRepeatOne"] = "Repeat: this song",
        ["TabSongs"] = "Songs",
        ...
        ["AutoFavoriteOn"] = "Favorite",
        ["AutoFavoriteOff"] = "Add to favorites",
        ["ActionGoToArtist"] = "Go to artist",
        ["ActionEditTags"] = "Edit song info",
        ...
        ["DeleteSongsTitle"] = "Delete songs",
        ["DeleteSongsMessage"] = "{0} songs will be deleted from this device. This cannot be undone.",
        ["SongsDeleted"] = "{0} songs deleted",
        ...
        ["TagTrack"] = "Track",
        ["TagYear"] = "Year",
        ["EditTagsScope"] = "Fixing these fields is what makes search and grouping get it right. The correction is kept by the app and, if the system allows it, also written to the media index; the audio file itself is never rewritten.",
        ["EditTagsReset"] = "Undo the correction",
        ["EditTagsNeedTitle"] = "The title cannot be empty",
        ["EditTagsSaved"] = "Info saved",
        ["EditTagsSavedInApp"] = "Info saved in the app only",
        ["EditTagsReverted"] = "Back to the file info",
        ["ActionSongInfo"] = "Song details and lyrics",
        ["RenameGroupTitle"] = "Rename group",
        ["GroupRenamed"] = "{0} songs updated",
        ["InfoUpdated"] = "Info updated",
        ["InfoNotFound"] = "Nothing found for this group",
        ["LookupInfo"] = "Look up info online",
        ["LookupSearching"] = "Looking it up...",
        ["LookupNeedsOnline"] = "Turn on online lookup in Settings to search for song info.",
        ["LookupNoResults"] = "Nothing found for this song",
        ["LookupFoundTitle"] = "Info found",
        ["LookupApply"] = "Use it",
        ["LookupApplied"] = "Fields filled in; check them and save",

        // --- Ficha de la cancion ---
        ["SongDetailsTitle"] = "Song details",
        ["SongDetailsFile"] = "File",
        ["SongDetailsDuration"] = "Length",
        ["ArtistSection"] = "About the artist",
        ["ArtistSectionOffline"] = "Turn on online lookup in Settings to see the artist's photo and bio.",
        ["ArtistSectionEmpty"] = "No info found for this artist",
        ["LyricsSection"] = "Lyrics",
        ["LyricsFrom"] = "From: {0}",
        ["LyricsSynced"] = "Follows the music",
        ["LyricsNone"] = "This song carries no lyrics. Music Player reads them from the song's own tag or from an .lrc file next to it: it never downloads them.",

        // --- Seleccion multiple ---
        ["SelectedCountOne"] = "1 selected",
        ["SelectedCountMany"] = "{0} selected",
        ...
        ["RemovedFromPlaylistMany"] = "{0} songs removed from this playlist",
        ["SelectPlaylistsTitle"] = "Add to playlists",
        ["SelectPlaylistsHint"] = "Pick every playlist this song should belong to.",
        ["SelectPlaylistsHintMany"] = "Pick the playlists to add these songs to.",
        ["NothingAdded"] = "No playlist was picked",
        ...
        ["DeepScanButton"] = "Search the whole phone",
        ["DeepScanHint"] = "Asks the system to re-index the internal storage and every card, then adds what it finds. It can take a few minutes.",
        ["IncludeAllAudio"] = "Include all audio",
        ["IncludeAllAudioHint"] = "Also what the system does not flag as music: recordings, podcasts, audiobooks (30 seconds or longer).",
        ["ScanArtButton"] = "Find covers",
        ["ScanArtHint"] = "For each song without a cover, takes the picture embedded in the file or the cover.jpg in its folder.",
        ["ScanTagsButton"] = "Re-read tags",
        ["ScanTagsHint"] = "Reads title, artist, album, composer, year and track again from the files and fills in what is missing. What you corrected by hand is kept.",
        ["ScanProgressFormat"] = "{0} of {1}…",
        ["ScanningVolumeFormat"] = "Indexing {0}…",
        ["DeepScanResultFormat"] = "{0} new songs",
        ["ScanArtResultFormat"] = "Covers found: {0}",
        ["ScanTagsResultFormat"] = "Songs completed: {0}",
    ...
    private static readonly Dictionary<string, string> Spanish = new(StringComparer.Ordinal)
    {
        ...
        ["Cancel"] = "Cancelar",
        ["ArtTitle"] = "Imagen",
        ["ArtFromDevice"] = "Del dispositivo",
        ["ArtFromUrl"] = "De una dirección",
        ["ArtSearchGoogle"] = "Buscarla en Google",
        ["ArtRemove"] = "Quitar la personalizada",
        ["ArtUrlTitle"] = "Dirección de la imagen",
        ["ArtUrlMessage"] = "Pega la dirección de la imagen (botón derecho sobre ella, «Copiar dirección de la imagen»).",
        ["ArtSaved"] = "Imagen guardada.",
        ["ArtFailed"] = "No se pudo usar la imagen",
        ["Close"] = "Cerrar",
        ["Create"] = "Crear",
        ["Delete"] = "Eliminar",
        ...
        ["TabArtists"] = "Grupos",
        ["AutoShuffleOn"] = "Aleatorio: sí",
        ["AutoShuffleOff"] = "Aleatorio: no",
        ["AutoRepeatOff"] = "Repetir: no",
        ["AutoRepeatAll"] = "Repetir: la lista",
        ["AutoRepeatOne"] = "Repetir: esta canción",
        ["TabSongs"] = "Canciones",
        ["TabPlaylists"] = "Listas",
        ...
        ["ActionAddFavorite"] = "Añadir a favoritas",
        ["ActionRemoveFavorite"] = "Quitar de favoritas",
        ["Favorites"] = "Favoritas",
        ["FavoriteAdded"] = "Añadida a favoritas",
        ["FavoriteRemoved"] = "Quitada de favoritas",
        ["AutoFavoriteOn"] = "Favorita",
        ["AutoFavoriteOff"] = "Añadir a favoritas",
        ["ActionGoToArtist"] = "Ir al grupo",
        ["ActionEditTags"] = "Editar la información",
        ...
        ["DeleteSongsTitle"] = "Eliminar canciones",
        ["DeleteSongsMessage"] = "Se eliminarán {0} canciones de este dispositivo. No se puede deshacer.",
        ["SongsDeleted"] = "{0} canciones eliminadas",
        ["SongDeleted"] = "Canción eliminada",
        ["DeleteFailed"] = "No se ha podido eliminar la canción",
        ["DeleteCancelled"] = "No se ha eliminado nada",

        // --- Edicion de etiquetas ---
        ["EditTagsTitle"] = "Información de la canción",
        ["TagTitle"] = "Título",
        ["TagArtist"] = "Artista",
        ["TagAlbumArtist"] = "Artista del álbum",
        ["TagAlbum"] = "Álbum",
        ["TagComposer"] = "Compositor",
        ["TagTrack"] = "Pista",
        ["TagYear"] = "Año",
        ["EditTagsScope"] = "Corregir estos campos es lo que hace que la búsqueda y la agrupación acierten. La corrección la guarda la aplicación y, si el sistema lo permite, se escribe también en el índice de medios; el archivo de audio no se reescribe nunca.",
        ["EditTagsReset"] = "Deshacer la corrección",
        ["EditTagsNeedTitle"] = "El título no puede quedar vacío",
        ["EditTagsSaved"] = "Información guardada",
        ["EditTagsSavedInApp"] = "Información guardada solo en la aplicación",
        ["EditTagsReverted"] = "Se vuelve a la información del archivo",
        ["ActionSongInfo"] = "Ficha y letra",
        ["RenameGroupTitle"] = "Renombrar grupo",
        ["GroupRenamed"] = "{0} canciones actualizadas",
        ["InfoUpdated"] = "Información actualizada",
        ["InfoNotFound"] = "No se ha encontrado nada de este grupo",
        ["LookupInfo"] = "Buscar información en internet",
        ["LookupSearching"] = "Buscando...",
        ["LookupNeedsOnline"] = "Activa la búsqueda en internet en Configuración para buscar la información de la canción.",
        ["LookupNoResults"] = "No se ha encontrado nada de esta canción",
        ["LookupFoundTitle"] = "Información encontrada",
        ["LookupApply"] = "Usarla",
        ["LookupApplied"] = "Campos rellenados; revísalos y guarda",

        // --- Ficha de la cancion ---
        ["SongDetailsTitle"] = "Ficha de la canción",
        ["SongDetailsFile"] = "Archivo",
        ["SongDetailsDuration"] = "Duración",
        ["ArtistSection"] = "Sobre el grupo",
        ["ArtistSectionOffline"] = "Activa la búsqueda en internet en Configuración para ver la foto y la reseña del grupo.",
        ["ArtistSectionEmpty"] = "No se ha encontrado información de este grupo",
        ["LyricsSection"] = "Letra",
        ["LyricsFrom"] = "De: {0}",
        ["LyricsSynced"] = "Sigue la música",
        ["LyricsNone"] = "Esta canción no trae letra. Music Player la lee de la etiqueta de la propia canción o de un archivo .lrc a su lado: nunca la descarga.",

        // --- Seleccion multiple ---
        ["SelectedCountOne"] = "1 seleccionada",
        ["SelectedCountMany"] = "{0} seleccionadas",
        ...
        ["RemovedFromPlaylistMany"] = "{0} canciones quitadas de esta lista",
        ["SelectPlaylistsTitle"] = "Añadir a listas",
        ["SelectPlaylistsHint"] = "Marca todas las listas a las que quieras añadir la canción.",
        ["SelectPlaylistsHintMany"] = "Marca las listas a las que quieras añadir estas canciones.",
        ["NothingAdded"] = "No se ha marcado ninguna lista",
        ...
        ["DeepScanButton"] = "Buscar en todo el móvil",
        ["DeepScanHint"] = "Pide al sistema que vuelva a indexar la memoria interna y todas las tarjetas, y añade lo que encuentre. Puede tardar unos minutos.",
        ["IncludeAllAudio"] = "Incluir todo el audio",
        ["IncludeAllAudioHint"] = "También lo que el sistema no marca como música: grabaciones, podcasts, audiolibros (de 30 segundos o más).",
        ["ScanArtButton"] = "Buscar carátulas",
        ["ScanArtHint"] = "Para cada canción sin carátula, saca la imagen que lleva dentro el fichero o el cover.jpg de su carpeta.",
        ["ScanTagsButton"] = "Releer etiquetas",
        ["ScanTagsHint"] = "Vuelve a leer título, grupo, álbum, compositor, año y pista desde los ficheros y rellena lo que falte. Lo que hayas corregido a mano se respeta.",
        ["ScanProgressFormat"] = "{0} de {1}…",
        ["ScanningVolumeFormat"] = "Indexando {0}…",
        ["DeepScanResultFormat"] = "{0} canciones nuevas",
        ["ScanArtResultFormat"] = "Carátulas encontradas: {0}",
        ["ScanTagsResultFormat"] = "Canciones completadas: {0}",
        ["ScanBusy"] = "Ya hay un escaneo en marcha",
